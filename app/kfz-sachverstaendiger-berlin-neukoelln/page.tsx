...
export const metadata: Metadata = {
  ...
  keywords: [
    "kfz sachverständiger neukölln",
    "kfz gutachter neukölln berlin",
    "unfallgutachten neukölln",
    "gutachter sonnenallee",
  ],
};
      ...
      <section className="relative px-5 pt-16 pb-14 overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          ...
          <h1 className="font-display font-black text-4xl md:text-6xl text-white uppercase tracking-tight leading-tight mb-5">
            ...
            <span className="text-[#E11D2F]">Berlin Neukölln</span>
          </h1>

          <p className="text-white/60 text-[16px] md:text-[18px] leading-relaxed max-w-xl mx-auto mb-8">
            Neukölln — einer der dichtesten Berliner Bezirke mit viel Verkehr auf der Sonnenallee und Karl-Marx-Straße. Unfall in Neukölln? Wir kommen direkt zu Ihnen und erstellen Ihr Gutachten in <strong className="text-white">24 Stunden</strong> — bei unverschuldetem Unfall für Sie <strong className="text-[#22c55e]">100% kostenlos</strong>.
          </p>
      ...
      <section className="bg-white px-5 py-16">
        <div className="max-w-3xl mx-auto">
          <h2 className="font-display font-black text-3xl md:text-4xl text-[#080D14] uppercase text-center mb-10">
            Ihr KFZ Gutachter in Berlin Neukölln
          </h2>
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              ...
              { icon: Clock, title: "Gutachten in 24 Stunden", text: "Wir kommen direkt nach Berlin Neukölln — nach Hause, in die Werkstatt oder zum Unfallort." },
      ...
      <section className="bg-[#080D14] px-5 py-10 border-t border-white/6">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="font-display font-black text-2xl md:text-3xl text-white uppercase mb-4">
            KFZ Gutachter & Sachverständiger in Berlin Neukölln
          </h2>
          <p className="text-white/50 text-[14px] leading-relaxed max-w-2xl mx-auto">
            Als <strong className="text-white">KFZ Sachverständiger Berlin Neukölln</strong> und <strong className="text-white">KFZ Gutachter Berlin Neukölln</strong> stehen wir Ihnen nach jedem Unfall sofort zur Seite.
            Unser Unfallgutachten für Neukölln ist TÜV Rheinland zertifiziert und wird von allen Versicherungen anerkannt.
            Als unabhängiger Gutachter in Berlin Neukölln arbeiten wir ausschließlich in Ihrem Interesse — nicht im Interesse der Versicherung.
          </p>
