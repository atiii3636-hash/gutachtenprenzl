...
export const metadata: Metadata = {
  title: "KFZ Sachverständiger Berlin Reinickendorf – Unfallgutachten in 24h",
  description: "TÜV-zertifizierter KFZ Sachverständiger in Berlin Reinickendorf. Unfallgutachten in 24h, kostenlos bei Fremdverschulden. Jetzt anrufen: 0155 60003661",
  alternates: { canonical: "https://gutachtenprenzl.de/kfz-sachverstaendiger-berlin-reinickendorf" },
  keywords: [
    "kfz sachverständiger reinickendorf",
    "kfz gutachter reinickendorf berlin",
    "unfallgutachten reinickendorf",
    "gutachter tegel berlin",
  ],
};
    ...
    <div className="min-h-screen bg-[#080D14]">
      ...
      <section className="relative px-5 pt-16 pb-14 overflow-hidden">
        <Image
          ...
          alt="KFZ Sachverständiger bei der Schadensbegutachtung in Berlin Reinickendorf"
          fill
          priority
          sizes="100vw"
          quality={75}
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          ...
          <h1 className="font-display font-black text-4xl md:text-6xl text-white uppercase tracking-tight leading-tight mb-5">
            ...
            <span className="text-[#E11D2F]">Berlin Reinickendorf</span>
          </h1>

          <p className="text-white/60 text-[16px] md:text-[18px] leading-relaxed max-w-xl mx-auto mb-8">
            Reinickendorf im Berliner Norden mit dem Tegeler See und dem Flughafen-Gebiet. Unfall in Reinickendorf? Wir kommen direkt zu Ihnen und erstellen Ihr Gutachten in <strong className="text-white">24 Stunden</strong> — bei unverschuldetem Unfall für Sie <strong className="text-[#22c55e]">100% kostenlos</strong>.
          </p>
      ...
      <section className="bg-white px-5 py-16">
        <div className="max-w-3xl mx-auto">
          <h2 className="font-display font-black text-3xl md:text-4xl text-[#080D14] uppercase text-center mb-10">
            Ihr KFZ Gutachter in Berlin Reinickendorf
          </h2>
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              ...
              { icon: Clock, title: "Gutachten in 24 Stunden", text: "Wir kommen direkt nach Berlin Reinickendorf — nach Hause, in die Werkstatt oder zum Unfallort." },
      ...
      <section className="bg-[#080D14] px-5 py-10 border-t border-white/6">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="font-display font-black text-2xl md:text-3xl text-white uppercase mb-4">
            KFZ Gutachter & Sachverständiger in Berlin Reinickendorf
          </h2>
          <p className="text-white/50 text-[14px] leading-relaxed max-w-2xl mx-auto">
            Als <strong className="text-white">KFZ Sachverständiger Berlin Reinickendorf</strong> und <strong className="text-white">KFZ Gutachter Berlin Reinickendorf</strong> stehen wir Ihnen nach jedem Unfall sofort zur Seite.
