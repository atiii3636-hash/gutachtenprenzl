...
export const metadata: Metadata = {
  title: "KFZ Gutachter Lichtenberg – Unfallgutachten in 24h",
  description: "TÜV-zertifizierter KFZ Gutachter in Berlin Lichtenberg. Unfallgutachten in 24h, kostenlos bei Fremdverschulden. Jetzt anrufen: 0155 60003661",
  alternates: { canonical: "https://gutachtenprenzl.de/kfz-gutachter-lichtenberg" },
};
    ...
    <div className="min-h-screen bg-[#080D14]">
      ...
      <section className="relative px-5 pt-16 pb-14 overflow-hidden">
        <Image
          ...
          alt="KFZ Sachverständiger bei der Schadensbegutachtung in Berlin Lichtenberg"
          fill
          priority
          sizes="100vw"
          quality={75}
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          ...
          <h1 className="font-display font-black text-4xl md:text-6xl text-white uppercase tracking-tight leading-tight mb-5">
            KFZ Gutachter<br />
            <span className="text-[#E11D2F]">Lichtenberg</span>
          </h1>

          <p className="text-white/60 text-[16px] md:text-[18px] leading-relaxed max-w-xl mx-auto mb-8">
            Unfall in Lichtenberg? Wir kommen direkt zu Ihnen und erstellen Ihr Gutachten in <strong className="text-white">24 Stunden</strong> — bei unverschuldetem Unfall für Sie <strong className="text-[#22c55e]">100% kostenlos</strong>.
          </p>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              ...
              { icon: Clock, title: "Gutachten in 24 Stunden", text: "Wir kommen direkt nach Lichtenberg — nach Hause, in die Werkstatt oder zum Unfallort." },
