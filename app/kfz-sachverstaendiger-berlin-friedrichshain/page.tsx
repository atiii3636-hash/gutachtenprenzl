...
export const metadata: Metadata = {
  title: "KFZ Sachverständiger Berlin Friedrichshain – Unfallgutachten in 24h",
  description: "TÜV-zertifizierter KFZ Sachverständiger in Berlin Friedrichshain. Unfallgutachten in 24h, kostenlos bei Fremdverschulden. Jetzt anrufen: 0155 60003661",
  alternates: { canonical: "https://gutachtenprenzl.de/kfz-sachverstaendiger-berlin-friedrichshain" },
  keywords: [
    "kfz sachverständiger friedrichshain",
    "kfz gutachter friedrichshain",
    "unfallgutachten friedrichshain berlin",
    "gutachter east side gallery",
  ],
};
    ...
    <div className="min-h-screen bg-[#080D14]">
      ...
      <section className="relative px-5 pt-16 pb-14 overflow-hidden">
        <Image
          ...
          alt="KFZ Sachverständiger bei der Schadensbegutachtung in Berlin Friedrichshain"
          fill
          priority
          sizes="100vw"
          quality={75}
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          ...
          <h1 className="font-display font-black text-4xl md:text-6xl text-white uppercase tracking-tight leading-tight mb-5">
            ...
            <span className="text-[#E11D2F]">Berlin Friedrichshain</span>
          </h1>

          <p className="text-white/60 text-[16px] md:text-[18px] leading-relaxed max-w-xl mx-auto mb-8">
            Friedrichshain — zwischen East Side Gallery und Boxhagener Platz. Unfall in Friedrichshain? Wir kommen direkt zu Ihnen und erstellen Ihr Gutachten in <strong className="text-white">24 Stunden</strong> — bei unverschuldetem Unfall für Sie <strong className="text-[#22c55e]">100% kostenlos</strong>.
          </p>
      ...
      <section className="bg-white px-5 py-16">
        <div className="max-w-3xl mx-auto">
          <h2 className="font-display font-black text-3xl md:text-4xl text-[#080D14] uppercase text-center mb-10">
            Ihr KFZ Gutachter in Berlin Friedrichshain
          </h2>
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              ...
              { icon: Clock, title: "Gutachten in 24 Stunden", text: "Wir kommen direkt nach Berlin Friedrichshain — nach Hause, in die Werkstatt oder zum Unfallort." },
      ...
      <section className="bg-[#080D14] px-5 py-10 border-t border-white/6">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="font-display font-black text-2xl md:text-3xl text-white uppercase mb-4">
            KFZ Gutachter & Sachverständiger in Berlin Friedrichshain
          </h2>
          <p className="text-white/50 text-[14px] leading-relaxed max-w-2xl mx-auto">
            Als <strong className="text-white">KFZ Sachverständiger Berlin Friedrichshain</strong> und <strong className="text-white">KFZ Gutachter Berlin Friedrichshain</strong> stehen wir Ihnen nach jedem Unfall sofort zur Seite.
      ...
      <section className="bg-white px-5 py-14 border-t border-gray-100">
        <div className="max-w-3xl mx-auto">
          <h2 className="font-display font-black text-2xl md:text-3xl text-[#080D14] uppercase mb-4">
            KFZ Gutachter in Berlin Friedrichshain
          </h2>
          <p className="text-gray-600 text-[15px] leading-relaxed mb-4">
            Friedrichshain ist ein stark befahrener Bezirk mit vielen Unfallschwerpunkten — besonders auf der Frankfurter Allee, der Karl-Marx-Allee und rund um den Boxhagener Platz. Parkrempler, Auffahrunfälle an Kreuzungen und Fahrrad-Kfz-Kollisionen sind typische Schadensfälle, die wir täglich bearbeiten.
          </p>
          <p className="text-gray-600 text-[15px] leading-relaxed">
            Von unserem Standort in der Prenzlauer Allee 88 sind wir in wenigen Minuten bei Ihnen in Friedrichshain. Wir begutachten Ihr Fahrzeug direkt vor Ort — ohne lange Wartezeiten.
          </p>
        </div>
      </section>
