...
export const metadata: Metadata = {
  title: "KFZ Sachverständiger Berlin Kreuzberg – Unfallgutachten in 24h",
  description: "TÜV-zertifizierter KFZ Sachverständiger in Berlin Kreuzberg. Unfallgutachten in 24h, kostenlos bei Fremdverschulden. Jetzt anrufen: 0155 60003661",
  alternates: { canonical: "https://gutachtenprenzl.de/kfz-sachverstaendiger-berlin-kreuzberg" },
  keywords: [
    "kfz sachverständiger kreuzberg",
    "kfz gutachter kreuzberg berlin",
    "unfallgutachten kreuzberg",
    "gutachter berlin kreuzberg",
  ],
};
    ...
    <div className="min-h-screen bg-[#080D14]">
      ...
      <section className="relative px-5 pt-16 pb-14 overflow-hidden">
        <Image
          ...
          alt="KFZ Sachverständiger bei der Schadensbegutachtung in Berlin Kreuzberg"
          fill
          priority
          sizes="100vw"
          quality={75}
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          ...
          <h1 className="font-display font-black text-4xl md:text-6xl text-white uppercase tracking-tight leading-tight mb-5">
            ...
            <span className="text-[#E11D2F]">Berlin Kreuzberg</span>
          </h1>

          <p className="text-white/60 text-[16px] md:text-[18px] leading-relaxed max-w-xl mx-auto mb-8">
            Kreuzberg mit seinen belebten Straßen rund um den Görli und die Bergmannstraße. Unfall in Kreuzberg? Wir kommen direkt zu Ihnen und erstellen Ihr Gutachten in <strong className="text-white">24 Stunden</strong> — bei unverschuldetem Unfall für Sie <strong className="text-[#22c55e]">100% kostenlos</strong>.
          </p>
      ...
      <section className="bg-white px-5 py-16">
        <div className="max-w-3xl mx-auto">
          <h2 className="font-display font-black text-3xl md:text-4xl text-[#080D14] uppercase text-center mb-10">
            Ihr KFZ Gutachter in Berlin Kreuzberg
          </h2>
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              ...
              { icon: Clock, title: "Gutachten in 24 Stunden", text: "Wir kommen direkt nach Berlin Kreuzberg — nach Hause, in die Werkstatt oder zum Unfallort." },
      ...
      <section className="bg-[#080D14] px-5 py-10 border-t border-white/6">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="font-display font-black text-2xl md:text-3xl text-white uppercase mb-4">
            KFZ Gutachter & Sachverständiger in Berlin Kreuzberg
          </h2>
          <p className="text-white/50 text-[14px] leading-relaxed max-w-2xl mx-auto">
            Als <strong className="text-white">KFZ Sachverständiger Berlin Kreuzberg</strong> und <strong className="text-white">KFZ Gutachter Berlin Kreuzberg</strong> stehen wir Ihnen nach jedem Unfall sofort zur Seite.
            Unser Unfallgutachten für Kreuzberg ist TÜV Rheinland zertifiziert und wird von allen Versicherungen anerkannt.
            Als unabhängiger Gutachter in Berlin Kreuzberg arbeiten wir ausschließlich in Ihrem Interesse — nicht im Interesse der Versicherung.
          </p>
          <p className="text-white/20 text-[11px] mt-4">
            kfz sachverständiger kreuzberg · kfz gutachter kreuzberg berlin · unfallgutachten kreuzberg · gutachter berlin kreuzberg
          </p>
        </div>
      </section>
      ...
      <section className="bg-white px-5 py-14 border-t border-gray-100">
        <div className="max-w-3xl mx-auto">
          <h2 className="font-display font-black text-2xl md:text-3xl text-[#080D14] uppercase mb-4">
            KFZ Gutachter in Berlin Kreuzberg
          </h2>
          <p className="text-gray-600 text-[15px] leading-relaxed mb-4">
            Kreuzberg ist eines der dichtbesiedelsten Viertel Berlins — mit hohem Verkehrsaufkommen auf dem Kottbusser Damm, der Gneisenaustraße und rund um den Mehringdamm. Fahrradunfälle, Dooring-Schäden und Kollisionen an engen Kreuzungen sind hier besonders häufige Schadensfälle, mit denen wir täglich umgehen.
          </p>
          <p className="text-gray-600 text-[15px] leading-relaxed">
            Als KFZ-Sachverständiger für Kreuzberg sind wir schnell vor Ort — direkt am Unfallort, bei Ihrer Werkstatt oder zu Hause. Von der Prenzlauer Allee 88 erreichen wir Kreuzberg in etwa 15 Minuten.
          </p>
        </div>
      </section>
